...
function instance($$self, $$props, $$invalidate) {
  var BORDER_STYLE = ["background: url(code-pirate.svg) no-repeat bottom #58a;", "background-position: right 20px bottom 10px;"].join("");
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_0x02_extended_position_bg> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_0x02_extended_position_bg", $$slots, []);
...
var _0x02_extended_position_bg = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_0x02_extended_position_bg, _SvelteComponentDev);

  var _super = _createSuper(_0x02_extended_position_bg);

  function _0x02_extended_position_bg(options) {
    var _this;

    _classCallCheck(this, _0x02_extended_position_bg);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_0x02_extended_position_bg",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _0x02_extended_position_bg;
}(SvelteComponentDev);

export default _0x02_extended_position_bg;
