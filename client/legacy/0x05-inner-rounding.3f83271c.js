...
function instance($$self, $$props, $$invalidate) {
  var BORDER_STYLE = ["box-shadow: 0 0 0 .4em #655;", "outline: .6em solid #655;"].join("");
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_0x05_inner_rounding> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_0x05_inner_rounding", $$slots, []);
...
var _0x05_inner_rounding = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_0x05_inner_rounding, _SvelteComponentDev);

  var _super = _createSuper(_0x05_inner_rounding);

  function _0x05_inner_rounding(options) {
    var _this;

    _classCallCheck(this, _0x05_inner_rounding);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_0x05_inner_rounding",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _0x05_inner_rounding;
}(SvelteComponentDev);

export default _0x05_inner_rounding;
