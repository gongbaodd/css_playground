...
function instance($$self, $$props, $$invalidate) {
  var bgStyle = "\nbackground-image: \n    linear-gradient(45deg, hsla(0, 0%, 100%, .5) 25%, transparent 0, transparent 75%, hsla(0, 0%, 100%, .5) 0),\n    linear-gradient(45deg, hsla(0, 0%, 100%, .5) 25%, transparent 0, transparent 75%, hsla(0, 0%, 100%, .5) 0);\nbackground-position: 0 0, 25px 25px;\nbackground-size: 50px 50px;\n  ";
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_1x06_checkerboard> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_1x06_checkerboard", $$slots, []);
...
var _1x06_checkerboard = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_1x06_checkerboard, _SvelteComponentDev);

  var _super = _createSuper(_1x06_checkerboard);

  function _1x06_checkerboard(options) {
    var _this;

    _classCallCheck(this, _1x06_checkerboard);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_1x06_checkerboard",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _1x06_checkerboard;
}(SvelteComponentDev);

export default _1x06_checkerboard;
