...
function instance($$self, $$props, $$invalidate) {
  var BORDER_STYLE = ["background: yellowgreen;", "box-shadow: 0 0 0 10px #655, 0 0 0 15px deeppink, 0 2px 5px 15px rgba(0,0,0,.6);"].join("");
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_0x01_multiple_borders> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_0x01_multiple_borders", $$slots, []);
...
var _0x01_multiple_borders = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_0x01_multiple_borders, _SvelteComponentDev);

  var _super = _createSuper(_0x01_multiple_borders);

  function _0x01_multiple_borders(options) {
    var _this;

    _classCallCheck(this, _0x01_multiple_borders);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_0x01_multiple_borders",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _0x01_multiple_borders;
}(SvelteComponentDev);

export default _0x01_multiple_borders;
