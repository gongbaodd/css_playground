...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_0x00_translucent_borders> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_0x00_translucent_borders", $$slots, []);
...
var _0x00_translucent_borders = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_0x00_translucent_borders, _SvelteComponentDev);

  var _super = _createSuper(_0x00_translucent_borders);

  function _0x00_translucent_borders(options) {
    var _this;

    _classCallCheck(this, _0x00_translucent_borders);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_0x00_translucent_borders",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _0x00_translucent_borders;
}(SvelteComponentDev);

export default _0x00_translucent_borders;
