...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_3x01_diamond> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_3x01_diamond", $$slots, []);
...
var _3x01_diamond = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_3x01_diamond, _SvelteComponentDev);

  var _super = _createSuper(_3x01_diamond);

  function _3x01_diamond(options) {
    var _this;

    _classCallCheck(this, _3x01_diamond);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_3x01_diamond",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _3x01_diamond;
}(SvelteComponentDev);

export default _3x01_diamond;
