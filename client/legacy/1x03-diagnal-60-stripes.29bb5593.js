...
function instance($$self, $$props, $$invalidate) {
  var bgStyle = "\n  background: repeating-linear-gradient(60deg, hsla(0, 0%, 100%, .5), hsla(0, 0%, 100%, .5) 15px, transparent 0, transparent 30px);\n  ";
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_1x03_diagnal_60_stripes> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_1x03_diagnal_60_stripes", $$slots, []);
...
var _1x03_diagnal_60_stripes = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_1x03_diagnal_60_stripes, _SvelteComponentDev);

  var _super = _createSuper(_1x03_diagnal_60_stripes);

  function _1x03_diagnal_60_stripes(options) {
    var _this;

    _classCallCheck(this, _1x03_diagnal_60_stripes);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_1x03_diagnal_60_stripes",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _1x03_diagnal_60_stripes;
}(SvelteComponentDev);

export default _1x03_diagnal_60_stripes;
