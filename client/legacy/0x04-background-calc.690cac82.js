...
function instance($$self, $$props, $$invalidate) {
  var BORDER_STYLE = ["background: url(code-pirate.svg) no-repeat bottom right #58a;", "background-position: calc(100% - 20px) calc(100% - 10px);"].join("");
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_0x04_background_calc> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_0x04_background_calc", $$slots, []);
...
var _0x04_background_calc = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_0x04_background_calc, _SvelteComponentDev);

  var _super = _createSuper(_0x04_background_calc);

  function _0x04_background_calc(options) {
    var _this;

    _classCallCheck(this, _0x04_background_calc);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_0x04_background_calc",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _0x04_background_calc;
}(SvelteComponentDev);

export default _0x04_background_calc;
