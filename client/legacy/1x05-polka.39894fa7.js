...
function instance($$self, $$props, $$invalidate) {
  var bgStyle = "\nbackground-image: radial-gradient(hsla(0, 0%, 100%, .5) 20%, transparent 0),\n                  radial-gradient(hsla(0, 0%, 100%, .5) 20%, transparent 0);\nbackground-size: 30px 30px;\nbackground-position: 0 0, 15px 15px;\n  ";
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_1x05_polka> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_1x05_polka", $$slots, []);
...
var _1x05_polka = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_1x05_polka, _SvelteComponentDev);

  var _super = _createSuper(_1x05_polka);

  function _1x05_polka(options) {
    var _this;

    _classCallCheck(this, _1x05_polka);
