...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_2x04_ant_match> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_2x04_ant_match", $$slots, []);
...
var _2x04_ant_match = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_2x04_ant_match, _SvelteComponentDev);

  var _super = _createSuper(_2x04_ant_match);

  function _2x04_ant_match(options) {
    var _this;

    _classCallCheck(this, _2x04_ant_match);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_2x04_ant_match",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _2x04_ant_match;
}(SvelteComponentDev);

export default _2x04_ant_match;
