...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<_1x02_diagnal_stripes> was created with unknown prop '".concat(key, "'"));
  });
  var _$$props$$$slots = $$props.$$slots,
      $$slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots,
      $$scope = $$props.$$scope;
  validate_slots("_1x02_diagnal_stripes", $$slots, []);
...
var _1x02_diagnal_stripes = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(_1x02_diagnal_stripes, _SvelteComponentDev);

  var _super = _createSuper(_1x02_diagnal_stripes);

  function _1x02_diagnal_stripes(options) {
    var _this;

    _classCallCheck(this, _1x02_diagnal_stripes);

    _this = _super.call(this, options);
    init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: _assertThisInitialized(_this),
      tagName: "_1x02_diagnal_stripes",
      options: options,
      id: create_fragment.name
    });
    return _this;
  ...
  return _1x02_diagnal_stripes;
}(SvelteComponentDev);

export default _1x02_diagnal_stripes;
